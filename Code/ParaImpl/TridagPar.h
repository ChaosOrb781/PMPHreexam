...
inline void tridagPar(
    const thrust::host_vector<REAL>&   a,   // size [n]
    const int             a_start,
    const thrust::host_vector<REAL>&   b,   // size [n]
    const int             b_start,
    const thrust::host_vector<REAL>&   c,   // size [n]
    const int             c_start,
    const thrust::host_vector<REAL>&   r,   // size [n]
    const int             r_start,
    const int             n,
          thrust::host_vector<REAL>&   u,   // size [n]
    const int             u_start,
          thrust::host_vector<REAL>&   uu,   // size [n] temporary
    const int             uu_start
) {
    //int i, offset;
