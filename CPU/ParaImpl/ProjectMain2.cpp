...
int main()
{
    ...
    if (is_valid) {
        ...
        RunTestOnProgram<funGPU>("Simple Kernel", (fun)run_CPUKernel, res_original, originalStat, outer, numX, numY, numT, s0, t, alpha, nu, beta, Block);
        RunTestOnProgram<funGPU>("Simple Kernel", (fun)run_GPUKernel, res_original, originalStat, outer, numX, numY, numT, s0, t, alpha, nu, beta, Block);
    }
