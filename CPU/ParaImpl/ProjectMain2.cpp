...
int main()
{
    ...
    if (is_valid) {
        ...
        RunTestOnProgram<funGPU>("Separation Rollback", (fun)run_Distributed_Parallel, res_original, originalStat, outer, numX, numY, numT, s0, t, alpha, nu, beta, Block);
        RunTestOnProgram<funGPU>("Separation Rollback Parallel", (fun)run_Distributed_Parallel, res_original, originalStat, outer, numX, numY, numT, s0, t, alpha, nu, beta, Block);
